  ...
  return (
    ...
    {user?.name?.split(' ')[0] || 'Guest'}
        ...
        <form onSubmit={handleSubmit} className="w-full">
          ...
          <button
            type="submit"
            className="mt-8 flex items-center shadow w-full justify-center md:w-max ml-auto bg-purple-600 px-4 py-2 text-white font-semibold rounded-lg disabled:pointer-events-none disabled:opacity-50"
