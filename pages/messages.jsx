        ...
        >
          {banner.name && banner.profilePicUrl ? (
            ...
            <div className="space-y-5">
              <div className="border border-purple-900 rounded-full inline-flex p-5 items-center justify-center">
                <ChatAltIcon className="h-20 w-20 text-purple-900" />
              </div>
