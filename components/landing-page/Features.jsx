...
const features = [
  ...
  },
  {
    ...
    description:
      'Devin will remain free forever with no advertisement, data collection, tracking or anything of that sorts!',
    icon: EmojiHappyIcon,
  },
];
    ...
    <div className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base text-purple-900 font-semibold tracking-wide uppercase">
            Features
          </h2>
