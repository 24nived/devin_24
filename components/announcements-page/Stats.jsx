...
const Stats = ({ users, posts }) => {
  ...
  return (
    <div className="bg-purple-900 pt-12 sm:pt-16">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <img
              ...
              alt="Devin - social media, but for developers | Product Hunt"
              width="250"
              height="54"
      ...
      <div className="mt-10 pb-12 bg-white sm:pb-16">
        <div className="relative">
          <div className="absolute inset-0 h-1/2 bg-purple-900" />
            ...
            <div className="max-w-4xl mx-auto">
              <dl className="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
                <div className="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                  ...
                  <dd className="order-1 text-5xl font-extrabold text-purple-900">
