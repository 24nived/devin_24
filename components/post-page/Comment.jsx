        ...
        <div className="ml-2 flex flex-col flex-1">
          ...
          <div className="flex items-center space-x-2 text-gray-700 mt-1">
            <div className="flex items-center space-x-1">
              {isLiked ? (
                <HeartSolidIcon
                  ...
                  className="h-4 w-4 text-purple-900 cursor-pointer"
                />
              ) : (
                <HeartOutlineIcon
                  onClick={() => likeMutation.mutate()}
            ...
            <a
              ...
              className="text-sm text-purple-900 cursor-pointer hover:underline"
            >
              Reply
            </a>
            {user && user._id === comment.user._id && (
              <TrashIcon
                ...
                className="h-4 w-4 cursor-pointer text-purple-900"
              />
            )}
          </div>
          {replyOpen && (
            <form onSubmit={postReply} className="relative mt-3 flex">
              <input
                className="border-2 rounded-l p-1.5 text-sm border-purple-900 w-full focus:outline-none"
              ...
              />
              <button className="bg-purple-900 rounded-r px-2 py-1  h-100">
