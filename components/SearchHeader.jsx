...
const SettingsHeader = () => {
  return (
    <Disclosure as="div" className="relative bg-purple-900 pb-24 overflow-hidden">
      {({ open }) => (
        <>
          <div
            ...
            aria-hidden="true"
          >
            <div className="flex-grow bg-purple-100 bg-opacity-75" />
            <svg
            ...
            <div className="flex-grow bg-purple-1100 bg-opacity-75" />
          </div>
